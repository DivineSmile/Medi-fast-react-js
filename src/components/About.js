...
function About() {
    return (
        ...
        <div className="row">
            ...
            <div className="about-content"><h4>MEDI-Fast deals with delivery of medicine faster.We are here to solve the problem of customers who is not getting medicine on time and could not visit shops offline. It will help old parents, family member having serious disease and lives miles apart.</h4>
            <p>We get medicines from joint ventures of medicine dealers, retailers and production houses directly and delivery to customers and small businesses.</p></div>
